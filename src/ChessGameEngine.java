...
public class ChessGameEngine {
    ...
    /**
     * Checks if the last-clicked piece is a valid piece (i.e. if it is the
     * correct color and if the user actually clicked ON a piece.)
     *
     ...
     *
     * @param checkCurrent if true, will check if the current king is in check
     * if false, will check if the other player's king is in check.
     ...
     *
     * @param endGameStr the string to display to the user (i.e. stalemate,
     * checkmate, etc)
     */
    ...
    public void determineActionFromSquareClick(MouseEvent e) {
        ...
        if (firstClick) {
            firstClickAction(squareClicked);
        } else {
            secondClickAction(pieceOnSquare, squareClicked);
        }
    }

    private void firstClickAction(BoardSquare squareClicked) throws HeadlessException {
        ...
        if (selectedPieceIsValid()) {
            ...
            if (currentPiece != null) {
                showMessageError(squareClicked, "You tried to pick up the other player's piece! "
                        + "Get some glasses and pick a valid square.",
                        "Illegal move");
            } else {
                showMessageError(squareClicked, "You tried to pick up an empty square! "
                        + "Get some glasses and pick a valid square.",
                        "Illegal move");
            }
        }
    ...
    private void secondClickAction(ChessGamePiece pieceOnSquare, BoardSquare squareClicked) throws HeadlessException {
    ...
    private void showMessageError(BoardSquare squareClicked, String message, String title) throws HeadlessException {
